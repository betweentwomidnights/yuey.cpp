...
const std::vector<std::string> kInstrumental = {
    ...
    "dub techno, submerged and patient, tape-delayed chord stabs, brushed noise floor",
    "deep house, warm and unhurried, Rhodes chords, filtered disco bass, shuffled hats",
    "electro, brittle and mechanical, 808 toms, vocoder-less synth lead, sharp claps",
    "ambient drone, glacial, bowed guitar, granular pads, no percussion",
    "IDM, fidgety and bright, chopped breaks, detuned bell synth, stuttering edits",
    "liquid drum and bass, spacious, sub bass, jazzy Rhodes, rolling amen break",
    "breakbeat hardcore, euphoric and rough, chopped funk drums, rave stabs, diving bass",
    "synthwave, neon and nocturnal, gated drums, analog lead, arpeggiated bassline",
    "downtempo trip hop, smoky and heavy-lidded, dusty drum loop, upright bass, muted trumpet",
    "psytrance, relentless, rolling bassline, acid arpeggio, tight kick",
    "footwork, frantic, chopped soul sample, skittering hats, sub-heavy 808",
    "lo-fi house, tape-saturated, slightly detuned keys, loose drum machine, vinyl hiss",
    "berlin school sequencer music, patient and vast, analog sequence, slow filter sweeps",
    "glitch, clinical and playful, clicks and cuts, tiny bell tones, sparse sub",
    ...
    "lo-fi beat, rainy and nostalgic, Rhodes loop, brushed drums, vinyl crackle",
    ...
    "cinematic hip hop, widescreen and aggressive, orchestral hits, heavy kick, taiko accents",
    ...
    // rock and metal
    "post-rock, slow-burning to enormous, clean tremolo guitar, swelling toms, distant cymbals",
    ...
    "spiritual jazz, searching and ecstatic, tenor saxophone, harp flourishes, loose ride cymbal",
    ...
    "free jazz, fractured and combustible, squalling saxophone, prepared piano, clattering kit",
    ...
    "celtic instrumental, wind-scoured, fiddle, bodhran, tin whistle, droning bouzouki",
    "west african highlife, bright and rolling, clean interlocking guitars, congas, horn lines",
    "andean folk, high and thin, charango, quena flute, bombo drum",
    "balkan brass, lurching and jubilant, tuba bassline, clarinet lead, snare rolls",
    "flamenco, taut and dramatic, nylon guitar, palmas, cajon",
    "carnatic fusion, intricate, veena, mridangam, drone tanpura",
    "appalachian old-time, rough-hewn, clawhammer banjo, fiddle, foot stomp",
    "gamelan-inspired, shimmering and cyclic, tuned metallophones, gongs, interlocking patterns",
    "klezmer, wheeling and bittersweet, clarinet lead, accordion, upright bass",
    "nordic folk, austere and open, nyckelharpa, frame drum, low drone",
    "delta blues instrumental, cracked and lonesome, slide guitar, stomping foot, harmonica",
    // classical and chamber
    "string quartet, restrained and aching, close harmony, long bows, no vibrato",
    "minimalist piano, patient and repetitive, slowly shifting cells, soft pedal",
    "baroque chamber, poised and ornamented, harpsichord, viola da gamba, recorder",
    "romantic solo piano, stormy, wide dynamics, dense left hand",
    "contemporary classical, spectral and uneasy, prepared piano, bowed cymbal, sustained strings",
    ...
    // cinematic and textural
    "cinematic score, foreboding and immense, low strings, pulsing timpani, brass swells",
    "horror score, creeping, detuned music box, bowed saw, subharmonic drone",
    "western score, dusty and wide, twangy guitar, whistled melody, sparse percussion",
    "noir score, rain-slicked, muted trumpet, vibraphone, brushed kit",
    "space ambient, weightless, slow pads, distant bell tones, faint radio static",
    "documentary underscore, curious and lightly propulsive, marimba, pizzicato strings, soft kit",
    "exotica, lush and improbable, vibraphone, bird calls, lazy bongos, tremolo guitar",
    "library music, brisk and businesslike, fuzz organ, tight kit, walking bass",
    // odd corners
    "dungeon synth, lo-fi and solitary, cheap string patch, hand drum, tape hiss",
    "vaporwave, sun-bleached and slowed, chopped lounge sample, wobbling pitch, soft rim clicks",
    "zeuhl, martial and alien, fuzz bass ostinato, chanting-free brass, insistent kit",
    "chiptune, gleeful and tinny, square lead, noise-channel percussion, arpeggiated bass",
    "tape loop music, decaying, degraded piano phrase, wow and flutter, hiss",
    "musique concrete, restless, contact-mic scrapes, filtered field recordings, sudden silences",
};
...
const std::vector<std::string> kVocal = {
    ...
    "murder ballad, grim and narrative, low male voice, banjo, creaking fiddle, sparse thump",
